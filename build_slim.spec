# PyInstaller spec: version SLIM (sans imageio-ffmpeg, ffmpeg requis sur le systeme).
# Lancer: pyinstaller build_slim.spec
...
_excludes_slim = _excludes_qt + ['imageio_ffmpeg']
